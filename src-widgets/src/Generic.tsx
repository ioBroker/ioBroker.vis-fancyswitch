...
/**
 * Base class of every fancyswitch widget.
 *
...
> extends (window.visRxWidget as typeof VisRxWidget)<RxData, State> {
    ...
    static getI18nPrefix(): string {
        return 'vis_fancyswitch_';
    }

    /** Class of the widget root; `fancy-rx-dark` switches the CSS variables of `styles.css` */
    getRootClass(): string {
        return this.props.context.themeType === 'dark' ? 'fancy-rx fancy-rx-dark' : 'fancy-rx';
    }
}
